...
public class DeadLockExample {
    ...
    public static class Task1 implements Runnable {
        ...
        @Override
        public void run() {
            pen.writeWithPenAndPaper(paper); // thread1 locks pen object and tries to lock paper
        }
    }
    ...
    public static class Task2 implements Runnable {
        ...
        @Override
        public void run() {
            paper.writeWithPaperAndPen(pen); // thread2 locks paper object and tries to lock pen
        }
    }
